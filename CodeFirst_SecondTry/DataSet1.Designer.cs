...
namespace CodeFirst_SecondTry {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class STUDENTDataTable : global::System.Data.TypedTableBase<STUDENTRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public STUDENTRow AddSTUDENTRow(decimal ID, string FIRSTNAME, string LASTNAME, string ADDRESS, string CITY) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public STUDENTRow FindByID(decimal ID) {
        ...
        public partial class STUDENTRow : global::System.Data.DataRow {
            ...
            public decimal ID {
                get {
                    return ((decimal)(this[this.tableSTUDENT.IDColumn]));
                }
                set {
...
namespace CodeFirst_SecondTry.DataSet1TableAdapters {
    ...
    public partial class STUDENTTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM ""MAHMOUD"".""STUDENT"" WHERE ((""ID"" = :Original_ID) AND ((:IsNull_FIRSTNAME = 1 AND ""FIRSTNAME"" IS NULL) OR (""FIRSTNAME"" = :Original_FIRSTNAME)) AND ((:IsNull_LASTNAME = 1 AND ""LASTNAME"" IS NULL) OR (""LASTNAME"" = :Original_LASTNAME)) AND ((:IsNull_ADDRESS = 1 AND ""ADDRESS"" IS NULL) OR (""ADDRESS"" = :Original_ADDRESS)) AND ((:IsNull_CITY = 1 AND ""CITY"" IS NULL) OR (""CITY"" = :Original_CITY)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO \"MAHMOUD\".\"STUDENT\" (\"ID\", \"FIRSTNAME\", \"LASTNAME\", \"ADDRESS\", \"CITY\"" +
                ") VALUES (:ID, :FIRSTNAME, :LASTNAME, :ADDRESS, :CITY)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE ""MAHMOUD"".""STUDENT"" SET ""ID"" = :ID, ""FIRSTNAME"" = :FIRSTNAME, ""LASTNAME"" = :LASTNAME, ""ADDRESS"" = :ADDRESS, ""CITY"" = :CITY WHERE ((""ID"" = :Original_ID) AND ((:IsNull_FIRSTNAME = 1 AND ""FIRSTNAME"" IS NULL) OR (""FIRSTNAME"" = :Original_FIRSTNAME)) AND ((:IsNull_LASTNAME = 1 AND ""LASTNAME"" IS NULL) OR (""LASTNAME"" = :Original_LASTNAME)) AND ((:IsNull_ADDRESS = 1 AND ""ADDRESS"" IS NULL) OR (""ADDRESS"" = :Original_ADDRESS)) AND ((:IsNull_CITY = 1 AND ""CITY"" IS NULL) OR (""CITY"" = :Original_CITY)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CodeFirst_SecondTry.Properties.Settings.Default.ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, FIRSTNAME, LASTNAME, ADDRESS, CITY FROM MAHMOUD.STUDENT";
        ...
        public virtual int Delete(decimal Original_ID, string Original_FIRSTNAME, string Original_LASTNAME, string Original_ADDRESS, string Original_CITY) {
        ...
        public virtual int Insert(decimal ID, string FIRSTNAME, string LASTNAME, string ADDRESS, string CITY) {
        ...
        public virtual int Update(decimal ID, string FIRSTNAME, string LASTNAME, string ADDRESS, string CITY, decimal Original_ID, string Original_FIRSTNAME, string Original_LASTNAME, string Original_ADDRESS, string Original_CITY) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FIRSTNAME, string LASTNAME, string ADDRESS, string CITY, decimal Original_ID, string Original_FIRSTNAME, string Original_LASTNAME, string Original_ADDRESS, string Original_CITY) {
            return this.Update(Original_ID, FIRSTNAME, LASTNAME, ADDRESS, CITY, Original_ID, Original_FIRSTNAME, Original_LASTNAME, Original_ADDRESS, Original_CITY);
        }
    }
